...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 32 characters. Example: <code>a</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/customer/baskets/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/customer/baskets/16"
);
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               step="any"               name="basketSlug"                data-endpoint="GETapi-customer-baskets--basketSlug-"
               value="16"
               data-component="url">
    <br>
