...
use App\Repositories\Customer\Eloquent\EloquentCustomerApiTokenRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(CustomerApiTokenRepositoryInterface::class, EloquentCustomerApiTokenRepository::class);
